...
[source,sh]
----
$ jbang -Dcamel.jbang.version=4.7.0-SNAPSHOT camel run timer-to-azure-servicebus.camel.yaml
----
...
[source,sh]
----
$ jbang -Dcamel.jbang.version=4.7.0-SNAPSHOT camel run azure-servicebus-to-log.camel.yaml
----
